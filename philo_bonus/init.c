...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/07/09 17:48:24 by lykalon           #+#    #+#             */
/*   Updated: 2022/07/10 16:49:14 by lykalon          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_philo	*ft_philo_init(t_simulation *simulation)
{
	...
	while (++i < simulation->philo_numbers)
		ft_for_philos(simulation, philo, i);
	return (philo);
}

void	ft_for_philos(t_simulation *simulation, t_philo *philo, int i)
{
	philo[i].index = i;
	philo[i].is_dead = NO;
